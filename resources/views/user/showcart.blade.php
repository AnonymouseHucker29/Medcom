...
<body>
  ...
  <header class="">
    ...
    <div align="center">
      ...
      <br>
      <button class="btn btn-success" id="orderError" onclick="orderError()" style="background-color: orangered; border-color: orangered;">Confirm Order</button>
      </form>
    </div>
